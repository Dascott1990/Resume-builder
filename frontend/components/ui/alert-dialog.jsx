...
const AlertDialogOverlay = React.forwardRef(function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      className={cn(
        // z-[60] — same reasoning dialog.jsx's own overlay uses: this had
        // the identical un-fixed bug (plain z-50) until now, meaning a
        // confirm dialog triggered from inside a Select/Dialog/Sheet
        // could render behind it.
